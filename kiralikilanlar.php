...
if(isset($_REQUEST["kategoriid"])){
	...
	$toplamkayitsayisisorgusu            =   $baglanti->prepare("SELECT * from ilanlar where yayindurumu='1' $kategorikosulu $aramakosulu $fiyataramakosulu $bolgearamakosulu and kategorituru='Kiralık Daire' or kategorituru='Kiralık İşyeri' or kategorituru='Kiralık Günlük' order by id desc");
...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="index.php">Anasayfa</a> / Kiralık İlanlar</span>
...
<?php 
  ...
  $ilanlarsorgusu = $baglanti->prepare("SELECT * from ilanlar where yayindurumu='1' and kategorituru='Kiralık Daire' or kategorituru='Kiralık İşyeri' or kategorituru='Kiralık Günlük' order by id asc limit $sayfalamayabaslanacakkayitsayisi,$sayfabasinagosterilecekkayitsayisi");
...
<div class="pull-left" style="margin-top: 10px; margin-bottom:10px;">
  <div style="text-align: center; margin-top:10px;">Toplam <?php echo $bulunansayfasayisi;?> Sayfada, <?php echo $toplamkayitsayisisorgusu;?> Adet Kayıt Bulunmaktadır  </div>
<!--  <select  name="siralama" class="form-control">
  <option id="0">Sırala</option>          
  <option id="1">Önce En Düşük Fiyat</option>
  <option id="2">Önce En Yüksek Fiyat</option>
  <option id="3">Önce En Yeniler</option>
  <option id="4">En Çok Görüntülenenler</option>
</select> -->
...
<div class="row">
<?php
  $ilanlarsorgusu = $baglanti->prepare("SELECT * from ilanlar where yayindurumu='1' $kategorikosulu $aramakosulu $fiyataramakosulu $bolgearamakosulu and kategorituru='Kiralık Daire' or kategorituru='Kiralık İşyeri' or kategorituru='Kiralık Günlük' order by id desc limit $sayfalamayabaslanacakkayitsayisi,$sayfabasinagosterilecekkayitsayisi");
  $ilanlarsorgusu->execute();
  $ilansayisi = $ilanlarsorgusu->rowcount();
  $ilankayitlari = $ilanlarsorgusu->fetchall(PDO::FETCH_ASSOC);
  $dongusayisi=1;
  ...
  ?>
     <!-- properties -->
      ...
      <div class="properties">
        <div class="image-holder"><img src="resimler/ilanresimleri/kiralikilanlar/<?php echo donusumlerigeridondur($kayitlar["ilanresmibir"]); ?>" class="img-responsive" alt="properties">
          <div class="status new">Salih Emlak'tan Kiralık</div>
        </div>
        ...
        <p class="price">Kira : <?php echo fiyatbicimlendir(donusumlerigeridondur($kayitlar["ilanfiyati"]));?>₺</p>
    ...
    <?php
    if ($sayfalama>1){
    echo "<span class='sayfalamapasif'><a href='index.php?sk=33" . $sayfalamakosulu ."&syf=1'><<</a> </span>";
    $sayfalamaicinsayfadegerinibirgerial   =   $sayfalama-1;
    echo "<span class='sayfalamapasif'><a href='index.php?sk=33" . $sayfalamakosulu ."&syf=". $sayfalamaicinsayfadegerinibirgerial .  "'><</a> </span>";                                       
    }
    ...
    echo "<span class='sayfalamaaktif'> " . $sayfalamaicinsayfaindexdegeri . "</span>";
      ...
      echo "<span class='sayfalamapasif'><a href='index.php?sk=33" . $sayfalamakosulu ."&syf=". $sayfalamaicinsayfaindexdegeri . "'> ". 
    ...
    echo "<span class='sayfalamapasif'><a href='index.php?sk=33" . $sayfalamakosulu ."&syf=". $sayfalamaicinsayfadegerinibirilerial . "'>></a> </span>";   
    echo "<span class='sayfalamapasif'><a href='index.php?sk=33" . $sayfalamakosulu ."&syf=". $bulunansayfasayisi  . "'>>></a> </span>";
