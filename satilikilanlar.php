...
if(isset($_REQUEST["kategoriid"])){
	...
	$toplamkayitsayisisorgusu            =   $baglanti->prepare("SELECT * from ilanlar where yayindurumu='1' $kategorikosulu $aramakosulu $fiyataramakosulu $bolgearamakosulu and kategorituru='Satılık Daire' or kategorituru='Satılık İşyeri' or kategorituru='Satılık Arsa' order by id desc");
...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="index.php">Anasayfa</a> / Satılık İlanlar</span>
...
<?php 
  ...
  $ilanlarsorgusu = $baglanti->prepare("SELECT * from ilanlar where yayindurumu='1' and kategorituru='Satılık Daire' or kategorituru='Satılık İşyeri' or kategorituru='Satılık Arsa' order by id asc limit $sayfalamayabaslanacakkayitsayisi,$sayfabasinagosterilecekkayitsayisi");
...
<?php
  ...
  ?>
     <!-- properties -->
      ...
      <div class="properties">
        <div class="image-holder"><img src="resimler/ilanresimleri/satilikilanlar/<?php echo donusumlerigeridondur($kayitlar["ilanresmibir"]); ?>" class="img-responsive" alt="properties">
          <div class="status sold">Salih Emlak'tan Satılık</div>
        </div>
        ...
        <p class="price">Fiyat : <?php echo fiyatbicimlendir(donusumlerigeridondur($kayitlar["ilanfiyati"]));?>₺</p>
    ...
    <?php
    if ($sayfalama>1){
    echo "<span class='sayfalamapasif'><a href='index.php?sk=32" . $sayfalamakosulu ."&syf=1'><<</a> </span>";
    $sayfalamaicinsayfadegerinibirgerial   =   $sayfalama-1;
    echo "<span class='sayfalamapasif'><a href='index.php?sk=32" . $sayfalamakosulu ."&syf=". $sayfalamaicinsayfadegerinibirgerial .  "'><</a> </span>";                                       
    }
    ...
    echo "<span class='sayfalamaaktif'> " . $sayfalamaicinsayfaindexdegeri . "</span>";
      ...
      echo "<span class='sayfalamapasif'><a href='index.php?sk=32" . $sayfalamakosulu ."&syf=". $sayfalamaicinsayfaindexdegeri . "'> ". 
    ...
    echo "<span class='sayfalamapasif'><a href='index.php?sk=32" . $sayfalamakosulu ."&syf=". $sayfalamaicinsayfadegerinibirilerial . "'>></a> </span>";   
    echo "<span class='sayfalamapasif'><a href='index.php?sk=32" . $sayfalamakosulu ."&syf=". $bulunansayfasayisi  . "'>>></a> </span>";
